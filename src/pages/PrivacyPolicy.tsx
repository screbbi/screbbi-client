  ...
  return (
    <div className="">
      ...
      <div className="w-10/12 mx-auto my-8">
        <div className="terms-main-title">Privacy Policy</div>
        <div className="terms-text">
          ...
          the screbbi.com website ("Website" or "Service") and any of its
        ...
        <div className="terms-title">Automatic collection of information</div>
        <div className="terms-text">
        ...
        <div className="terms-title">Collection of personal information</div>
        <div className="terms-text">
          ...
          address). In addition, if you link your Google account or accounts
          from other third party services, we also get information from those
          accounts. The information we get from those services depends on your
          settings and their privacy policies. We receive and store any
        ...
        <div className="terms-title">Disclosure of information</div>
        <div className="terms-text">
        ...
        <div className="terms-title">Retention of information</div>
        <div className="terms-text">
        ...
        <div className="terms-title">Transfer of information</div>
        <div className="terms-text">
        ...
        <div className="terms-title">The rights of users</div>
        <div className="terms-text">
          ...
          given your consent to the processing of your information; <br />
          ...
          than consent; <br /> (iii) you have the right to learn if information
          is being processed by us, obtain disclosure regarding certain aspects
          of the processing and obtain a copy of the information undergoing
          processing; <br />
          (iv) you have the right to verify the accuracy of your information and
          ask for it to be updated or corrected; <br />
          ...
          your information for any purpose other than storing it; <br />
          (vi) you have the right, under certain circumstances, to obtain the
          erasure of your Personal Information from us; <br />
        ...
        <div className="terms-title">The right to object to processing</div>
        <div className="terms-text">
        ...
        <div className="terms-title">Data protection rights under GDPR</div>
        <div className="terms-text">
        ...
        <div className="terms-title">California privacy rights</div>
        <div className="terms-text">
        ...
        <div className="terms-title">How to exercise these rights</div>
        <div className="terms-text">
        ...
        <div className="terms-title">Privacy of children</div>
        <div className="terms-text">
        ...
        <div className="terms-title">Cookies</div>
        <div className="terms-text">
        ...
        <div className="terms-title">Do Not Track signals</div>
        <div className="terms-text">
        ...
        <div className="terms-title">Email marketing</div>
        <div className="terms-text">
        ...
        <div className="terms-title">Information security</div>
        <div className="terms-text">
        ...
        <div className="terms-title">Acceptance of this policy</div>
        <div className="terms-text">
