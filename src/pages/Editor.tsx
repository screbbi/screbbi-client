  ...
  const adjustHeight = () => {
    if (textAreaRef.current) {
      ...
      textAreaRef.current.style.height =
        textAreaRef.current.scrollHeight - 24 + "px"; // Set height to scrollHeight
    }
  };
              ...
              <div className="editor">
                ...
                {selectionCoords && (
                  <div
                    ...
                    style={{
                      left:
                        selectionCoords.left < 260
                          ? selectionCoords.left
                          : selectionCoords.left > 800
                          ? selectionCoords.left - 550
                          : selectionCoords.left - 250,
                      top: selectionCoords.top - 150,
                    }}
                  >
                    <div
                      className="pop"
