...
import WriteSettings from "./WriteSettigs";
import Prompt from "./Prompt";
import RewriteOption from "./RewriteOption";
...
const Navbar = ({
  ...
  topPageRef: any;
  optionRef: any;
  openWriteOptions: boolean;
  setOpenWriteOptions: (e: boolean) => void;
  openWriteSettings: boolean;
  setOpenWriteSettings: (e: boolean) => void;
  openPrompt: boolean;
  setOpenPrompt: (e: boolean) => void;
}) => {
  return (
